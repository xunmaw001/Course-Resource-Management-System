            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">编辑作业信息</li>
                    </ol>
                </div>
            </div>
        </div>
                            ...
                            <!-- 当前表的字段 -->
                                ...
                                <input id="yonghuId" name="yonghuId" type="hidden">
                                    ...
                                    <div class="form-group col-md-6" style="display:none">
                                        <label>交付状态</label>
                                        <select id="zuoyeTypesSelect" name="zuoyeTypes" class="form-control">
                                        </select>
                                    </div>
...
<script>
    ...
    //数字检查
        <!-- 当前表的数字检查 -->
        function zuoyePingfenChickValue(e){
    ...
    <!--  当前表的数据回显  -->
        ...
        $("#zuoyePingfen").val(ruleForm.zuoyePingfen);
