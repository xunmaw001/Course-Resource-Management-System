        ...
        <div id="content">
            ...
            <div class="container mt-0">
                <div class="row breadcrumb-bar">
                    <div class="col-md-6">
                        <h3 class="block-title">作业信息管理</h3>
                    </div>
                    <div class="col-md-6">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item">作业信息管理</li>
                            <li class="breadcrumb-item active">作业信息列表</li>
                        </ol>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="widget-area-2 lochana-box-shadow">
                            <h3 class="widget-title">作业信息列表</h3>
                            <div class="table-responsive mb-3">
                                <div class="col-sm-12">
                                    ...
                                    <div class="layui-inline" style="margin-left: 30px;margin-bottom: 10px;">
                                        ...
                                        <button onclick="add()" type="button" class="btn btn-success 新增">添加作业</button>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel">评分</h5>
                        ...
                        <div class="modal-body">
                            <div class="row">
                                ...
                                <div class="col-sm-9">
                                    ...
                                    <input type="number" id="pingfen" name="pingfen" class="form-control">
                                </div>
                            </div>
                        </div>
                        <div class="modal-footer">
                            <button type="button" class="btn btn-secondary" data-dismiss="modal">关闭</button>
                            <button type="button" id="receive" onclick="pingfen()" class="btn btn-primary">发布</button>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <script>
        ...
        function setDataRow(item, number) {
            ...
            row.appendChild(zuoyeContentCell);
                    ...
                    //作业交付时间
            var kechengRenzhiyaoqiuCell = document.createElement('td');
            kechengRenzhiyaoqiuCell.innerHTML = item.kechengRenzhiyaoqiu;
            row.appendChild(kechengRenzhiyaoqiuCell);
            ...
            if(item.zuoyeFile ==null || item.zuoyeFile == '' || item.zuoyeFile == 'null'){
                    zuoyeFileCell.innerHTML = '作业未交付';
            }else {
                var zuoyeFileFile = document.createElement('button');
                    zuoyeFileFile.innerHTML = '下载作业';
            ...
            //教师评分
            var zuoyePingfenCell = document.createElement('td');
            if(item.zuoyeFile ==null || item.zuoyeFile == '' || item.zuoyeFile == 'null'){
                zuoyePingfenCell.innerHTML = '作业未交付';
            }else if(item.zuoyePingfen == null){
                zuoyePingfenCell.innerHTML = "未评分";
            }else{
                zuoyePingfenCell.innerHTML = item.zuoyePingfen;
            }
            row.appendChild(zuoyePingfenCell);


            //交付时间
            var insertTimeCell = document.createElement('td');
            if(item.zuoyeFile ==null || item.zuoyeFile == '' || item.zuoyeFile == 'null'){
                insertTimeCell.innerHTML = '作业未交付';
            }else{
            ...
            if(item.zuoyeFile !=null && item.zuoyeFile !=""){
                //修改按钮
                var editBtn = document.createElement('button');
                var editAttr = 'iddd(' + item.id + ')';
                editBtn.setAttribute("type", "button");
                editBtn.setAttribute("class", "btn btn-warning btn-sm 评分");
                editBtn.setAttribute("data-toggle", "modal");
                editBtn.setAttribute("data-target", "#exampleModal");
                editBtn.setAttribute("onclick", editAttr);
                editBtn.innerHTML = "评分";
        ...
        function pingfen() {
            var mymessage = confirm("真的确定评分数为: "+$("#pingfen").val()+" 吗？");
            if (mymessage == true) {
                http("zuoye/pingfen?pingfen="+$("#pingfen").val()+"&ids="+$("#ids").val(), "get", {}, (res) => {
                    if(res.code == 0)
                {
                    getDataList();
                    alert('操作成功');
