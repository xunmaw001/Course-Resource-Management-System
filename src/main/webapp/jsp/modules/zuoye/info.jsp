    ...
    <div id="content">
        ...
        <div class="container mt-0">
            <div class="row breadcrumb-bar">
                <div class="col-md-6">
                    <h3 class="block-title">编辑作业信息</h3>
                </div>
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">作业信息登记</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="widget-area-2 lochana-box-shadow">
                        <h3 class="widget-title">作业信息信息</h3>
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 级联表所有字段 -->
                                    ...
                                    <div class="form-group col-md-6">
                                        <label>课程类型</label>
                                        <input id="kechengValue" name="kechengValue" class="form-control"
                                    ...
                                    <div class="form-group col-md-6">
                                        <label>视频</label>
                                        <input id="kechengVideo" name="kechengVideo" class="form-control"
                                               v-model="ruleForm.kechengVideo" readonly>
                                    </div>


                                        <div class="form-group col-md-6">
                                            <label>课程时间/分钟</label>
                                            <input id="kechengShijian" name="kechengShijian" class="form-control"
                                                   v-model="ruleForm.kechengShijian" readonly>
                                        </div>
                                    ...
                                    <div>
                                        ...
                                        <div class="form-group col-md-6">
                                            <label>作业交付时间</label>
                                            <input id="kechengRenzhiyaoqiu" name="kechengRenzhiyaoqiu" class="form-control"
                                                   v-model="ruleForm.kechengRenzhiyaoqiu" readonly>
                                        </div>
                            ...
                            <!-- 本表所有字段 -->
                                ...
                                <div class="form-group col-md-6">
                                    <label>交付状态</label>
                                    <input id="zuoyeValue" name="zuoyeValue" class="form-control"
                                    ...
                                    <div class="form-group col-md-6">
                                        <label>教师评分</label>
                                        <input id="zuoyePingfen" name="zuoyePingfen" class="form-control"
                                               v-model="ruleForm.zuoyePingfen" readonly>
                                    </div>
