                    ...
                    <div class="widget-area-2 lochana-box-shadow">
                        ...
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 级联表的字段 -->
                                    ...
                                    <div class="form-group col-md-6 jiaoshi">
                                        <label>邮箱</label>
                                        <input id="jiaoshiEmail" name="jiaoshiEmail" class="form-control"
                            ...
                            <!-- 当前表的字段 -->
                                    ...
                                    <div class="form-group col-md-6">
                                        <label>课程类型</label>
                                        <select id="kechengTypesSelect" name="kechengTypes" class="form-control">
                                        </select>
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label>课件</label>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input id="kechengShijian" name="kechengShijian" class="form-control"
                                               onchange="kechengShijianChickValue(this)"  placeholder="课程时间/分钟">
                                    </div>
...
<script>
    ...
    function getContent() {
        ...
        if($("#zuoyeContentupload").length>0) {
            ...
            if (zuoyeContentEditor.hasContents()) {
                $('#zuoyeContent-input').attr('value', zuoyeContentEditor.getPlainTxt());
            }
        }
        if($("#kechengContentupload").length>0) {
            ...
            if (kechengContentEditor.hasContents()) {
                $('#kechengContent-input').attr('value', kechengContentEditor.getPlainTxt());
            }
        }
    }
    //数字检查
        <!-- 当前表的数字检查 -->
        function kechengShijianChickValue(e){
    ...
    function validform() {
        return $("#addOrUpdateForm").validate({
            ...
            messages: {
                ...
                kechengFile: "课件不能为空",
                kechengVideo: "视频不能为空",
                kechengShijian: "课程时间/分钟不能为空",
                jiaoshiId: "负责教师不能为空",
                zuoyeContent: "作业信息不能为空",
                kechengRenzhiyaoqiu: "作业交付时间不能为空",
    ...
    <!--  当前表的数据回显  -->
        ...
        $("#kechengRenzhiyaoqiu").val(ruleForm.kechengRenzhiyaoqiu);
